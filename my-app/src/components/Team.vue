 ...
 <div class="column is-7 ">
  <div class="myHero hero-right">
    ...
    <div class="tile is-child panel is-primary">
      <p class="panel-heading">Imane Chatri '23</p>
      <div class="panel-block">
      <div class="card-image has-text-centered">
        <div class="columns">
      <figure class="image is-128x128 is-inline-block">
          <div class="column is-13">
  <img src="https://blogger.googleusercontent.com/img/a/AVvXsEhR-MdG4DkTLDy_5uITULOrK11kYBsqI_LxSvhoountnHhgbpFag3IGRSdpHCgWM3pDq3yDC0ItF2lY7iq6BA_iHH17TTMthaUMdj4ouwdKZDzyX-40LsI7COIg8L5oUfOOy847sx0HoQc8KCK64oHHSt1ZTliHFQnut2BHwtJQWUFeF9M0Sy3a2jU_=s320">
</div>
</figure>
<div class="column is-7 ">
  <div class="myHero hero-right">
        <div class="hr"></div>
        <h1>Computer Science and Linguistics Major</h1>
</div>
</div>
</div>
</div>
